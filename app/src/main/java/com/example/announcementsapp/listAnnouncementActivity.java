    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                /*
                if (user != null) {
                    Toast.makeText(listTopicActivity.this, "User logged in ", Toast.LENGTH_SHORT).show();
                    session.logoutUser();;
                }*/
            }
        };
        ...
        if(Utilis.isInternetConnected(getApplicationContext())) {
            ...
            Query query = db.child("announcements").orderByChild("id");
            query.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                        ...
                        Announcement annOb = postSnapshot.getValue(Announcement.class);
                        announcement.add(annOb);
                    }
                    announcementListAdapter topicAdapter = new announcementListAdapter(listAnnouncementActivity.this, announcement);
